  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
       ...
       <!-- Header -->
       <form id="personalForm" action="application_action.php" method="post">
            ...
            <div class="card-header" style="font-weight: bold; font-size: 16px;">Fill Personal Details</div>
              <div class="card-body">
                ...
                <div class="form-group text-center">
                  ...
                  <input type="hidden" name="action" value="application_action" />
   ...
   $(document).ready(function() {
    ...
    $('#btn_personal_details').click(function() {
        ...
        $('#application_action').parsley();
          
          $('#application_action').on('submit', function(event){
          event.preventDefault();
          if($('#application_action').parsley().isValid())
          {
              $.ajax({
